...
export default function Home() {
  ...
  const [mlView, setmlView] = React.useState(false);
  ...
  if (homeView) {
    ...
    pageContent = (
      <div className={styles.homeTitle}>
        ...
        <Image src="https://lh3.googleusercontent.com/a/AGNmyxZ_R90Bnr_DT5501Z69BIxh4KNdcUmiuzlt12tXkmk=s576" />
      </div>
    );
  }
  if (currentView) {
  ...
  if (mlView) {
    headerContent = <ML renderHeader={true} />;
    pageContent = <ML renderHeader={false} />;
  }
  ...
  return (
    <Ant
      ...
      handleReplicateClick={handleReplicateClick}
      handleContactClick={handleContactClick}
      handleMLClick={handleMLClick}
    />
  );
}
