...
export default function Home(){
    ...
    <div>
        ...
        <p>starting - model is booting up, should take 1-5 minutes depending on model demand</p>
        <p>processing - model is currently running and processing your image</p>
        <p>done - image is processed and completed and shown!</p>

        <h2>Replicate</h2>
        <p>Replicate is a service that allows you to run Machine learning models with their cloud API! Type any image you would like to see generated by the stable diffusion model.</p>
        </div>
